/**
 * VoiceChat v10.0 — Responsive, enhanced, fun
 * 
    ...
    <div className="px-2 sm:px-3 py-2 bg-[#19191c] border-b border-[#282828] flex-shrink-0">
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2 min-w-0">
          {/* Mic icon with audio level ring */}
          <div className="relative flex-shrink-0">
            <div className="w-6 h-6 rounded-full flex items-center justify-center"
              style={{
                background: isInVoice
                  ? (isMuted ? 'rgba(255, 107, 107, 0.12)' : `rgba(91, 216, 130, ${0.08 + audioLevel * 0.15})`)
                  : 'rgba(255,255,255,0.03)',
                boxShadow: isInVoice && !isMuted && audioLevel > 0.1
                  ? `0 0 ${4 + audioLevel * 12}px rgba(91, 216, 130, ${audioLevel * 0.3})`
                  : 'none',
            ...
            {isInVoice && !isMuted && audioLevel > 0.15 && (
